...
const Index = () => {
  ...
  return <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      {/* Product in Use section */}
      <section className="relative py-20 bg-muted/30 z-10">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-black text-foreground mb-6">See It In Action</h2>
            <p className="text-xl text-foreground/80 font-medium max-w-2xl mx-auto">
              Watch families connect and learn together with personalized learning cards
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="flex items-center space-x-4 mb-4">
                  <div className="w-16 h-16 bg-art-yellow rounded-2xl flex items-center justify-center">
                    <Heart className="h-8 w-8 text-foreground" />
                  </div>
                  <div>
                    <h3 className="text-xl font-black text-foreground">Sample Card: Grandpa Joe</h3>
                    <p className="text-sm text-muted-foreground">Family Learning Card</p>
                  </div>
                </div>
                <div className="space-y-3">
                  <p className="text-foreground font-medium"><strong>Relationship:</strong> Grandfather</p>
                  <p className="text-foreground font-medium"><strong>Fun Fact:</strong> He used to be a pilot!</p>
                  <p className="text-foreground font-medium"><strong>Question:</strong> What was Grandpa's favorite place to fly to?</p>
                </div>
              </div>

              <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="flex items-center space-x-4 mb-4">
                  <div className="w-16 h-16 bg-art-pink rounded-2xl flex items-center justify-center">
                    <Users className="h-8 w-8 text-foreground" />
                  </div>
                  <div>
                    <h3 className="text-xl font-black text-foreground">Sample Card: Aunt Sarah</h3>
                    <p className="text-sm text-muted-foreground">Family Learning Card</p>
                  </div>
                </div>
                <div className="space-y-3">
                  <p className="text-foreground font-medium"><strong>Relationship:</strong> Mom's Sister</p>
                  <p className="text-foreground font-medium"><strong>Fun Fact:</strong> She speaks three languages!</p>
                  <p className="text-foreground font-medium"><strong>Question:</strong> Can you say 'hello' in all of Aunt Sarah's languages?</p>
                </div>
              </div>
            </div>

            <div className="bg-art-green/20 rounded-3xl p-8 text-center">
              <div className="bg-white rounded-2xl p-6 mb-6 shadow-lg">
                <img 
                  ...
                  alt="Family using learning cards together" 
                  className="w-full h-64 object-cover rounded-xl"
                />
              </div>
              <h3 className="text-2xl font-black text-foreground mb-4">Perfect for Family Time</h3>
              <p className="text-foreground/80 font-medium leading-relaxed">
                Turn any moment into a learning opportunity. Whether it's bedtime stories, car rides, or quiet afternoons together.
              </p>
            </div>
          </div>
        </div>
